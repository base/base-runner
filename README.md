...
### [.helpers](lib/config/asyncHelpers.js#L36)
...
Load pipeline plugins. Requires the [base-pipeline](https://github.com/node-base/base-pipeline) plugin to be registered.
