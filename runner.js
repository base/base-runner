...
module.exports = function(namespace, config) {
  ...
  Runner.prototype.generator = function(name) {
  ...
  Runner.prototype._listen = function() {
  ...
  Runner.prototype.register = function(name, options, generate) {
    ...
    var Ctor = opts.Generator || Generator;
    var base = this.base;

    var app = new Ctor(opts)
      .option('name', name)
  ...
  Runner.prototype.registerEach = function(pattern, config) {
  ...
  Runner.prototype.argv = function(argv, commands, fn) {
    var args = {};
    args.argv = argv;
    args.commands = [];
    args.generators = {};
  ...
  Runner.prototype.run = function(args, cb) {
  ...
  Runner.prototype.list = function(cb) {
